...
- **(10 поени)** Потребно е да овозможите пребарување на стартапи по име (дали испратениот текст се
  содржи во променливата `name`), проценка (стартапи со поголема проценка од внесената), година на формирање (стартапи формирани после внесената година), индустрија и основач преку
